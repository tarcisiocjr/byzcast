...
public class ReplicaReplier2 implements Replier, FIFOExecutable, Serializable, ReplyListener,BatchExecutable {
	 ...
	 * @param treeConfig
	 */
	public ReplicaReplier2(int RepID, int groupID, String treeConfig, int maxOutstanding) {
...
//// public class ReplicaReplier implements Replier, FIFOExecutable,
//// BatchExecutable, Serializable, ReplyListener {
//public class ReplicaReplier2 implements Replier, Serializable, ReplyListener, FIFOExecutable {
//
//	private static final long serialVersionUID = 1L;
//	// keep the proxy of all groups and compute lca etc/
//	private Tree overlayTree;
...
//
//				// this group is not the lcs, so not contacted directly from client
//				if (groupId != overlayTree.getLca(req.getDestIdentifier()).getID()) {
//					majReplicasOfSender = 4;//me.getParent().getProxy().getViewManager().getCurrentViewF() + 1;
//				}
//
//				// save message
//				ConcurrentSet<TOMMessage> msgs = saveRequest(message, req.getSeqNumber(), req.getClient());
